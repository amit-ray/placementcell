    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="mainbody">
                ...
                <div style="float : left; background-repeat: no-repeat;background-image: url(images/nitmas.jpg); width: 645px; height: 465px; " >
                   <br/><br/><br/>
                    <span> <h2 align="center"  style="margin: 150px 0 0 50px; color: #000;">

                            Welcome to Official website of <BR> NITMAS PLACEMENT CELL.
                            <Br>
                            This website is created to provide information
                            about the latest campus related activities of NITMAS.
                        </h2>
                    </span>>
